...
try {
  ...
  const internalComponents = new Set(['App', 'Pagination', 'SingleSender', 'BulkSender', 'LogsViewer', 'ResumeEditor', 'JdResumeTailor', 'LinkedInAutoPilot', 'NaukriAutoUploader', 'AdminDashboard', 'LoginPage']);
